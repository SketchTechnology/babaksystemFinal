        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
                ...
                <a href="" class="flex ml-2 md:mr-24">
                    <img src="{{ asset('frontend/assets/img/babak.png') }}" class="h-8 mr-3" alt="FlowBite Logo" />
                </a>
            ...
            @php
            $notifications = auth()->user()->notifications()->limit(4)->get();
            ...
            <div class="flex items-center">
                ...
                <button type="button" data-dropdown-toggle="notification-dropdown"
                    ...
                    <svg class="w-6 h-6" fill="<?php echo ($newCount > 0) ? 'red' : 'currentColor'; ?>" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"></path>
                        <!-- Add the text element for the number -->
                        <text x="50%" y="50%" font-size="10" fill="white" text-anchor="middle" dy=".3em" font-weight="bold">{{$newCount}}</text>
                    </svg>
                            ...
                            <a href="{{url("/dashboard")}}"
                                class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                                  <div class="flex-shrink-0">
                                    <img class="rounded-full w-11 h-11" src="https://static.vecteezy.com/system/resources/thumbnails/017/554/348/small/notification-bell-icon-ringing-bell-and-notification-sign-for-alarm-clock-and-smartphone-application-alert-or-new-message-for-web-site-design-logo-app-ui-vector.jpg"
                                        alt="Jese image">
                                    <div
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
         var notificationButton = document.querySelector('[data-dropdown-toggle="notification-dropdown"]');
        ...
        .catch(error => {
            ...
            notificationButton.querySelector('svg').setAttribute('fill', 'currentColor');
            newCount = 0;
             notificationButton.querySelector('text').textContent = newCount;
